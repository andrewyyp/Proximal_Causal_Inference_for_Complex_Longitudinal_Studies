...
# from small to large deviation from proximal independence assumption
...
# uncomment the following source code to save results from different generating mechanism corresponding to,
# from small to large deviation from proximal independence assumption
