para_set <- list(mu_X0 = -0.35,
                 ...
                 mu_U0 = 0.35,
                 sigma_U0 = 0.5,
                 alpha_A0 = c(-0.5, 0.2, 0.25, -0.2),
                 mu_Z0 = c(0.2, 0.5, 0.75),
                 sigma_Z0 = 0.5,
                 mu_W0 = c(0.2, 0.5, -0.75, -0.15),
                 sigma_W0 = 0.5,
                 mu_X1 = c(0.2, 0.7, 0.7, 0),
                 sigma_X1 = 0.5,
                 mu_U1 = c(0.2, 0.7, 0, 0.7),
                 sigma_U1 = 0.5,
                 alpha_A1 = c(-0.5, 0.5, 0.15, 0.25, 0.15, 0.25, 0.2, -0.3),
                 mu_Z1 = c(0.2, 0, 0.5, -0.75, 0.5, -0.75),
                 sigma_Z1 = 0.5,
                 mu_W1 = c(0.35, 0, -0.5, -0.75, 0.5, -0.75,-0.15, -0.15),
                 sigma_W1 = 0.5,
                 mu_Y = c(-1.3, 1, 1.14, 0, 0, 0, 0.5, -0.7, 0.2, -0.7, -0.1, -0.1),
                 sigma_Y = 0.5
)
